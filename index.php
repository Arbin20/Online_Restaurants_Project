    ...
    <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logoarbin.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                       <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">KRYEFAQJA <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">RESTORANTET <span class="sr-only"></span></a> </li>
                            
                            <?php
                        if(empty($_SESSION["user_id"]))
                            {
                                echo '<li class="nav-item"><a href="login.php" class="nav-link active">KYÇU</a> </li>
                              <li class="nav-item"><a href="registration.php" class="nav-link active">REGJISTROHU</a> </li>';
                            }
                        else
                            {
                                    
                                    
                                        echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active">POROSITË E TUA</a> </li>';
                                    echo  '<li class="nav-item"><a href="logout.php" class="nav-link active">ÇKYÇU</a> </li>';
                            }
        ...
        <section class="hero bg-image" data-image-src="images/img/backgroundlogo.jpg">
            
            <div class="hero-inner">
                <div class="container text-center font-white">
                    <h1 style="font-family: Cursive ">Dërgimi i porosisë deri në shtëpi dhe marrja e porosisë në Restorant</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4 style="font-family: aerial"><span style="color:white">1. </span><mark>Zgjedheni Restorantin</mark>  </h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4 style="font-family: aerial"><span style="color:white">2. </span><mark>Jepni Porosinë</mark></h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4 style="font-family: aerial"><span style="color:white">3. </span><mark>Porosit në shtëpi ose merreni vet</mark></h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Ushqimet më të shitura në këtë muaj</h2>
                    <p class="lead">Mënyra më e lehtë për porosinë e ushqimin tuaj të preferuar</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">MKD '.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Porosit Tani</a> </div>
                                                </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Mënyrë shumë e lehtë për të porositur ushqimin tuaj!</h2>
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Zgjedheni Restorantin</h3>
                                    <p>Ne ju kemi paraqitur menu të ndryshme nga restorantet të cilat ofrojnë ushqime në internet.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Zgjedheni Ushqimin Tuaj</h3>
                                <p>Nga çdo Restorant kemi vendosur ushqimet e tyre, dhe ju mund të bëni zgjedhjen më lehtë.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Dergimi ose Marja e Porosisë</h3>
                                <p>Porosinë mund të merni në Restorantin të cilin keni porositur ushqimin, por gjithashtu mundet që porosia tu vij deri në shtëpi! </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pagesa Kesh (Para në Dorë)</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Restorantet</h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
                                    <li><a href="#" class="selected" data-filter="*">Të Gjithë</a> </li>
									<?php 
