	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Madhësia maksimale e fotografise 1024kb!</strong> Provo fotografi tjetër.
															</div>';
					...
					elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Zgjedh Fotogtafinë</strong>
															</div>';
					}
					else{
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Tipi i fotografisë nuk është valid!</strong>png, jpg, Gif pranohen.
															</div>';
                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Restorantet</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_category.php">Shto Lokacionet</a></li>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Regjistro Restorantin</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Emri i Restorantit</label>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Telefoni </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Uebfaqja</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Koha e Mbylljes</label>
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Ditët e Punës</label>
                                                    <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Zgjedheni Ditët--</option>
                                                        <option value="Mon-Tue">e Hënë-e Martë</option>
                                                        <option value="Mon-Wed">e Hënë-e Mërkurë</option> 
														<option value="Mon-Thu">e Hënë-e Enjte</option>
														<option value="Mon-Fri">e Hënë-e Premte</option>
														<option value="Mon-Sat">e Hënë-e Shtunë</option>
                                                        <option value="Mon-Sun">e Hënë-e Diellë</option>
                                                        </select>
                                                </div>
                                            </div>
											...
											<div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Fotografi</label>
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Zgjedheni Lokacionin</label>
                                        ...
                                        <h3 class="box-title m-t-40">Adresa e Restorantit</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_restaurant.php" class="btn btn-inverse">Largo</a>
                                    </div>
                                </form>
                            </div>
                        </div>
