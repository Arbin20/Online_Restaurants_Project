...
?>
    ...
    <tr>
      <td colspan="2"><b> Profili i <?php echo $row['f_name'];?></b></td>
...
<tr height="50">
     ...
     <tr height="50">
      ...
      { echo "<div class='btn btn-success'>Aktiv</div>";
} else{
  echo "<div class='btn btn-danger'>Jo Aktiv</div>";
}
        ?></td>
    </tr>
