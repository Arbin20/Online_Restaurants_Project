...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		{	
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																...
																<strong>Të gjithë të drejtat e rezervuara!</strong>
															</div>';
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Madhësia maksimale 1024kb!</strong> Provo fotografi tjetër.
															</div>';
									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Të dhënat u ndryshuan!</strong>
															</div>';
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
						 ...
						 <li> <a href="all_orders.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Porosi</span></a></li>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Shto Menu të Restorantit</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Emri i Ushqimit</label>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="MKD">
                                                   </div>
                                            </div>
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Zgjedh Lokacion</label>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="all_menu.php" class="btn btn-inverse">Largo</a>
                                    </div>
                                </form>
                            </div>
                        </div>
